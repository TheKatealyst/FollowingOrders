...
public class ScriptScene5FollowedOrders : MonoBehaviour
{
    ...
    public void Next()
    {
        ...
        else if (primeInt == 31)
        {
            ...
            DialogueDisplay.SetActive(true);
            Char1name.text = "";
            Char1speech.text = "People suddenly begin to panic. \r\n";
        }
        else if (primeInt == 32)
        {
            CharBox.SetActive(false);
            ...
            DialogueDisplay.SetActive(true);
            Char1name.text = "";
            Char1speech.text = "They claw at the doors.\r\n\r\nBut it's too late.\r\n";
        }
        else if (primeInt == 33)
        {
            CharBox.SetActive(false);
            ...
            DialogueDisplay.SetActive(true);
            Char1name.text = "";
            Char1speech.text = "You feel a shock run through your body..\r\nYou scream.\r\n\r\nAll 25 people do, as the electricity from the floor runs through them\r\nthey cry out a bloodcurling scream.\r\n";
        }
        else if (primeInt == 34)
        {
            CharBox.SetActive(false);
            ...
            DialogueDisplay.SetActive(true);
            Char1name.text = "";
            Char1speech.text = "The muslim woman tries not to drop her baby onto the electrified floor. \r\nIt cries.\r\n";
        }
        else if (primeInt == 35)
        {
            CharBox.SetActive(false);
            ...
            DialogueDisplay.SetActive(true);
            Char1name.text = "";
            Char1speech.text = "Suddenly it stops.";
        }
        else if (primeInt == 36)
        {
            CharBox.SetActive(false);
            ...
            DialogueDisplay.SetActive(true);
            Char1name.text = "";
            Char1speech.text = "You look around.\r\n\r\n\r\nThe old man lies dead on the floor..\r\n";
        }
        else if (primeInt == 37)
        {
            ...
            DialogueDisplay.SetActive(true);
            Char1name.text = "";
            Char1speech.text = "Who could do this?";
        }
